...
!-----------------------------------------------------------------------
     ...
     &     converge = 1.e-10_SCRIP_r8  ! convergence criterion
...
!-----------------------------------------------------------------------
      ...
      integer (SCRIP_i4), dimension(4), intent(out) ::
     &        src_add  ! address of each corner point enclosing P

      real (SCRIP_r8), dimension(4), intent(out) ::
...
!-----------------------------------------------------------------------
     ...
     &        plon    ! longitude of the search point
      ...
      integer (SCRIP_i4), dimension(2), intent(in) ::
...
!-----------------------------------------------------------------------
      ...
      integer (SCRIP_i4) :: n, ! dummy index
